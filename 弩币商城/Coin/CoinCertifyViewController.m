...
//    按钮
   ...
   UIButton *sureButton = [[UIButton alloc]init];
    ...
    if (isSuccess) {
        ...
        NSMutableAttributedString *str = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"糖库借呗借款额度：¥%@",[dataDic objectNilForKey:@"cash_credit_limit"] ]];
